...
:: Установка Stylelint и плагинов для Sass
echo 🚀 Устанавливаем Stylelint и плагины для Sass...
npm install --save-dev stylelint stylelint-config-standard stylelint-sass

:: Проверка успешности установки
if %ERRORLEVEL% EQU 0 (
    echo ✅ Stylelint с поддержкой Sass успешно установлен!
) else (
    echo ❌ Произошла ошибка при установке Stylelint с поддержкой Sass.
    exit /b 1
)
